  ...
  items: [
    {
      ...
      avatar: 'SD',
      rating: 5,
      text: 'Their customer support team is highly responsive and professional. Whenever any issue arises, the technical team acts quickly and ensures it is resolved efficiently. The level of dedication and service quality they maintain truly makes them one of the most dependable ISPs in Bangladesh.',
    },
    {
      name: 'Johirul Tarun',
      ...
      avatar: 'JT',
      rating: 5,
      text: 'Red Data Pvt. Limited has consistently delivered reliable and high-speed internet services. Their network stability and uptime are impressive, and customer support is always responsive and professional. Truly one of the most dependable ISPs in Bangladesh.',
    },
    {
      name: 'Shahidul Islam Mukul',
      role: 'Local Guide',
      avatar: 'SM',
      rating: 5,
      text: 'I am extremely satisfied with the service from Red Data Pvt. Limited. Whenever there is an issue, their technical team responds quickly and resolves it efficiently. Excellent customer care and commitment to service quality.',
    },
    {
      name: 'Sangita Sarker',
      role: 'Verified Customer',
      avatar: 'SS',
      rating: 5,
      text: 'Red Data Pvt. Limited has grown rapidly while maintaining high service standards. Their dedication to innovation, reliable connectivity, and customer satisfaction truly sets them apart in the ISP industry.',
    },
    {
      name: 'Sifat Karim',
      role: 'Local Guide',
      avatar: 'SK',
      rating: 5,
      text: 'Fully satisfied with their great service, specially their support/technical team is very fast and cooperative.',
    },
    {
      name: 'Tutul Islam',
      role: 'Verified Customer',
      avatar: 'TI',
      rating: 5,
      text: 'Their excellent service. Red Data\'s performance is satisfactory. They respond to any issue in the fastest time. I really like their customer service. I hope they will continue to maintain this standard. Can be recommended to anyone.',
    },
    {
      name: 'Ekramul Kabir',
      role: 'Verified Customer',
      avatar: 'EK',
      rating: 5,
      text: 'One of the most dependable ISPs for corporate & Bank solutions. Smooth connectivity with strong and stable network performance. Highly recommended.',
    },
    {
      ...
      avatar: 'ME',
      rating: 5,
      text: 'Great service, reliable connection, and good value for money. Highly recommended for anyone looking for a dependable ISP.',
    },
    {
      name: 'Ahashanul Haque Shuvo',
      role: 'Verified Customer',
      avatar: 'AH',
      rating: 5,
      text: 'Reliable bandwidth, consistent speed, and professional service. Red Data stands out in the market.',
    },
    {
      name: 'CAD Update',
      role: 'Verified Customer',
      avatar: 'CU',
      rating: 5,
      text: 'Red Data provides reliable and stable internet connectivity. Their support team is responsive and professional. Highly recommended for both corporate and home users.',
    },
    {
      name: 'Modasser Hossain',
      role: 'Verified Customer',
      avatar: 'MH',
      rating: 5,
      text: 'Red Data offers quality connectivity and reliable service. Perfect choice for corporate offices and businesses.',
    },
    {
      name: 'Razwan Khan',
      role: 'Verified Customer',
      avatar: 'RK',
      rating: 5,
      text: 'One of the dependable ISPs for corporate solutions. Smooth connectivity and strong network performance.',
    },
    {
      name: 'K M Al Muneem Siddiqui',
      role: 'Local Guide',
      avatar: 'KM',
      rating: 5,
      text: 'Excellent performance in both internet and corporate solutions. Happy with the service so far.',
    },
    {
      name: 'Khaza Mainuddin',
      role: 'Verified Customer',
      avatar: 'KM',
      rating: 5,
      text: 'Very professional company. Their internet and communication services are reliable and consistent.',
    },
    {
      name: 'Abdul Kuddus',
      role: 'Verified Customer',
      avatar: 'AK',
      rating: 5,
      text: 'Stable connection and fair pricing for corporate solutions. Recommended.',
    },
    {
      name: 'Monirul Islam',
      role: 'Verified Customer',
      avatar: 'MI',
      rating: 5,
      text: 'Red Data is very good ISP in Corporate and Home services.',
    },
    {
      name: 'Tazmirul',
      role: 'Verified Customer',
      avatar: 'TZ',
      rating: 5,
      text: 'Good quality service with consistent performance. Suitable for office and business use.',
    },
    {
      name: 'Abdus Salam Chowdhury',
      role: 'Verified Customer',
      avatar: 'AS',
      rating: 5,
      text: 'Using their service for quite some time. Speed and stability are satisfactory.',
    },
    {
      name: 'Pijush Roy',
      role: 'Verified Customer',
...
export const faqData = {
  ...
  items: [
    ...
    },
    {
      ...
      question_bn: 'মাসিক মূল্যের বাইরে কোনো লুকানো চার্জ আছে?',
      answer:
    ...
    },
    {
      ...
      question_bn: 'আপনারা কেমন গ্রাহক সহায়তা দিয়ে থাকেন?',
      answer:
